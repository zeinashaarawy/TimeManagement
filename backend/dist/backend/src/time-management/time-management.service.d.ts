...
export declare class TimeManagementService {
    ...
    getPendingExceptions(): Promise<(import("mongoose").FlattenMaps<import("mongoose").Document<unknown, {}, TimeException, {}, {}> & TimeException & {
        _id: Types.ObjectId;
    } & {
        __v: number;
    }> & Required<{
    ...
    approveException(id: string, comment: string): Promise<{
        message: string;
        exception: import("mongoose").Document<unknown, {}, import("mongoose").Document<unknown, {}, TimeException, {}, {}> & TimeException & {
            _id: Types.ObjectId;
        } & {
    ...
    rejectException(id: string, comment: string): Promise<{
        message: string;
        exception: import("mongoose").Document<unknown, {}, import("mongoose").Document<unknown, {}, TimeException, {}, {}> & TimeException & {
            _id: Types.ObjectId;
        } & {
