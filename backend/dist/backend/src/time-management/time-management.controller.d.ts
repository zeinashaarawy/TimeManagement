...
export declare class TimeManagementController {
    ...
    getPendingExceptions(): Promise<(import("mongoose").FlattenMaps<import("mongoose").Document<unknown, {}, import("./attendance/schemas/time-exception.schema").TimeException, {}, {}> & import("./attendance/schemas/time-exception.schema").TimeException & {
        _id: import("mongoose").Types.ObjectId;
    } & {
        __v: number;
    }> & Required<{
    ...
    approveException(id: string, body: {
        comment: string;
    }): Promise<{
        message: string;
        exception: import("mongoose").Document<unknown, {}, import("mongoose").Document<unknown, {}, import("./attendance/schemas/time-exception.schema").TimeException, {}, {}> & import("./attendance/schemas/time-exception.schema").TimeException & {
    ...
    rejectException(id: string, body: {
        comment: string;
    }): Promise<{
        message: string;
        exception: import("mongoose").Document<unknown, {}, import("mongoose").Document<unknown, {}, import("./attendance/schemas/time-exception.schema").TimeException, {}, {}> & import("./attendance/schemas/time-exception.schema").TimeException & {
