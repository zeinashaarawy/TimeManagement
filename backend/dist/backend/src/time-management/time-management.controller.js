...
let TimeManagementController = class TimeManagementController {
    ...
    async approveException(id, body) {
        if (!body.comment) {
            throw new common_1.BadRequestException('Comment is required for approval');
        }
        return this.tmService.approveException(id, body.comment);
    }
    async rejectException(id, body) {
        if (!body.comment) {
            throw new common_1.BadRequestException('Comment is required for rejection');
        }
...
__decorate([
    (0, common_1.Get)('exceptions/pending'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], TimeManagementController.prototype, "getPendingExceptions", null);
__decorate([
