...
_export(exports, {
    ...
    isDebugAddressEphemeral: function() {
        return isDebugAddressEphemeral;
    },
...
const isDebugAddressEphemeral = ()=>{
    var _getParsedDebugAddress;
    return ((_getParsedDebugAddress = getParsedDebugAddress()) == null ? void 0 : _getParsedDebugAddress.port) === 0;
};
