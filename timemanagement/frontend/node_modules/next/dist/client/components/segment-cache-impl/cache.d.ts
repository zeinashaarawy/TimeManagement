...
import type { NormalizedPathname, NormalizedNextUrl, NormalizedSearch, RouteCacheKey } from './cache-key';
import { type RouteParam } from '../../route-params';
import { type MapEntry, type FallbackType } from './cache-map';
...
export declare function getCanonicalSegmentKeypath(route: FulfilledRouteCacheEntry, cacheKey: SegmentCacheKey): SegmentCacheKeypath;
export declare function getGenericSegmentKeypathFromFetchStrategy(fetchStrategy: FetchStrategy, route: FulfilledRouteCacheEntry, cacheKey: SegmentCacheKey): SegmentCacheKeypath;
export declare function readSegmentCacheEntry(now: number, keypath: SegmentCacheKeypath): SegmentCacheEntry | null;
 ...
 * entry, If not, it adds an empty entry to the cache and returns it.
 */
export declare function readOrCreateSegmentCacheEntry(now: number, fetchStrategy: FetchStrategy, route: FulfilledRouteCacheEntry, cacheKey: SegmentCacheKey): SegmentCacheEntry;
export declare function readOrCreateRevalidatingSegmentEntry(now: number, fetchStrategy: FetchStrategy, route: FulfilledRouteCacheEntry, cacheKey: SegmentCacheKey): SegmentCacheEntry;
export declare function overwriteRevalidatingSegmentCacheEntry(fetchStrategy: FetchStrategy, route: FulfilledRouteCacheEntry, cacheKey: SegmentCacheKey): EmptySegmentCacheEntry;
export declare function upsertSegmentEntry(now: number, keypath: SegmentCacheKeypath, candidateEntry: SegmentCacheEntry): SegmentCacheEntry | null;
