...
const _segmentcache = require("../components/segment-cache");
...
function getFetchStrategyFromPrefetchProp(prefetchProp) {
    if (process.env.__NEXT_CACHE_COMPONENTS && process.env.__NEXT_CLIENT_SEGMENT_CACHE) {
        ...
        _segmentcache.FetchStrategy.PPR : // To preserve backwards-compatibility, anything other than `false`, `null`, or `"auto"` results in a full prefetch.
