...
${c}`,i=`,
${c}`);let n=Math.min(s.length,p),a=0;for(;a<n-1;a++){let t=e(String(a),s[a],o,l,u,c);r+=void 0!==t?t:"null",r+=i}let h=e(String(a),s[a],o,l,u,c);if(r+=void 0!==h?h:"null",s.length-1>p){let e=s.length-p-1;r+=`${i}"... ${d(e)} not stringified"`}return""!==u&&(r+=`
...
${v}`,n=`,
${v}`,i=Math.min(c.length,p),a=0;for(;a<i-1;a++){let t=e(String(a),c[a],m,g,v);r+=void 0!==t?t:"null",r+=n}let s=e(String(a),c[a],m,g,v);if(r+=void 0!==s?s:"null",c.length-1>p){let e=c.length-p-1;r+=`${n}"... ${d(e)} not stringified"`}return r+=`
