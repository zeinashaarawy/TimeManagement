...
export default function build(dir: string, reactProductionProfiling: boolean | undefined, debugOutput: boolean | undefined, debugPrerender: boolean | undefined, noMangling: boolean | undefined, appDirOnly: boolean | undefined, bundler: Bundler | undefined, experimentalBuildMode: 'default' | 'compile' | 'generate' | 'generate-env', traceUploadUrl: string | undefined, debugBuildAppPaths?: string[], debugBuildPagePaths?: string[]): Promise<void>;
export {};
