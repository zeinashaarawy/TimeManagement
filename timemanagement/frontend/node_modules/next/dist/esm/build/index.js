...
import { detectConflictingPaths, printCustomRoutes, printTreeView, copyTracedFiles, isReservedPage, isAppBuiltinPage, collectRoutesUsingEdgeRuntime, collectMeta, isProxyFile } from './utils';
...
export default async function build(dir, reactProductionProfiling = false, debugOutput = false, debugPrerender = false, noMangling = false, appDirOnly = false, bundler = Bundler.Turbopack, experimentalBuildMode, traceUploadUrl, debugBuildAppPaths, debugBuildPagePaths) {
    ...
    try {
       ...
       */ const sourcePages = new Map();
            ...
            await recordFrameworkVersion("16.0.2");
                        ...
                        exportPathMap: (defaultMap)=>{
                            ...
                            sortedStaticPaths.forEach(([originalAppPath, routes])=>{
                                ...
                                routes.forEach((route)=>{
                                    ...
                                    // completely static.
                                    !(config.experimental.clientSegmentCache && config.cacheComponents)) {
                                        return;
                                    }
                                    defaultMap[route.pathname] = {
                    ...
                    sortedStaticPaths.forEach(([originalAppPath, prerenderedRoutes])=>{
                        ...
                        for (const route of staticPrerenderedRoutes){
                            ...
                            if (cacheControl.revalidate !== 0) {
                                ...
                                // this route.
                                !(config.experimental.clientSegmentCache && config.cacheComponents && isRoutePPREnabled)) {
