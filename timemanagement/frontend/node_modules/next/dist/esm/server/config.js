...
import { CanaryOnlyConfigError, isStableBuild } from '../shared/lib/errors/canary-only-config-error';
 ...
 */ function assignDefaultsAndValidate(dir, userConfig, silent, phase) {
    ...
    if (phase === PHASE_DEVELOPMENT_SERVER && ((_result_experimental5 = result.experimental) == null ? void 0 : _result_experimental5.isolatedDevBuild)) {
