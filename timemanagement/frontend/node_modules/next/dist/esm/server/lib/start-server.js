...
import { RESTART_EXIT_CODE, getFormattedDebugAddress, getNodeDebugType, isDebugAddressEphemeral } from './utils';
...
export async function startServer(serverOptions) {
    ...
    process.title = `next-server (v${"16.0.2"})`;
    let handlersReady = ()=>{};
    let handlersError = ()=>{};
    ...
    await new Promise((resolve)=>{
        server.on('listening', async ()=>{
            ...
            if (nodeDebugType) {
                ...
                Log.info(`the --${nodeDebugType} option was detected` + (isEphemeral ? '' : `, the Next.js router server should be inspected at ${formattedDebugAddress}.`));
            }
