...
import { formatDebugAddress, formatNodeOptions, getNodeDebugType, getParsedDebugAddress, getParsedNodeOptionsWithoutInspect } from '../server/lib/utils';
    ...
    constructor(workerPath, options){
        ...
        if (debuggerPortOffset !== -1) {
            ...
            if (nodeDebugType) {
                ...
                address.port = address.port === 0 ? 0 : address.port + // current process runs on `address.port`
